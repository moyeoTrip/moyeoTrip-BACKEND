...
class TravelCourseController(
    ...
    @GetMapping("/public")
    fun getPublicCourses(): List<TravelCourseInformationResponse> = chatRoomService.getPublicCourses()
    ...
    @Operation(summary = "공개 여행 코스 상세 조회")
    @GetMapping("/{courseId}")
    fun getCourse(
        @PathVariable courseId: Long,
    ): TravelCourseInformationResponse = chatRoomService.getCourse(courseId)
