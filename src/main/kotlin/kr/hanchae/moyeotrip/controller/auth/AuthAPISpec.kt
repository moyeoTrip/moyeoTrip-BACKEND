...
private object AuthSwaggerExamples {
    ...
    const val LOGIN_EXISTING = """{"accessToken":"eyJhbGciOiJIUzI1NiJ9.access...","refreshToken":"eyJhbGciOiJIUzI1NiJ9.refresh...","isNewUser":false,"providerType":"EMAIL"}"""
    const val LOGIN_NEW = """{"accessToken":null,"refreshToken":null,"isNewUser":true,"providerType":"APPLE"}"""
    const val LOGIN_KAKAO = """{"accessToken":"eyJhbGciOiJIUzI1NiJ9.access...","refreshToken":"eyJhbGciOiJIUzI1NiJ9.refresh...","isNewUser":false,"providerType":"KAKAO"}"""
    const val LOGIN_EMAIL = """{"accessToken":"eyJhbGciOiJIUzI1NiJ9.access...","refreshToken":"eyJhbGciOiJIUzI1NiJ9.refresh...","isNewUser":false,"providerType":"EMAIL"}"""
    const val LOGIN_APPLE = """{"accessToken":"eyJhbGciOiJIUzI1NiJ9.access...","refreshToken":"eyJhbGciOiJIUzI1NiJ9.refresh...","isNewUser":false,"providerType":"APPLE"}"""
